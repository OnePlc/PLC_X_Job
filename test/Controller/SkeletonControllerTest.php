<?php
/**
 * JobControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Job Module
 *
 * @category Test
 * @package Job
...
namespace OnePlaceTest\Job\Controller;
...
class JobControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/job', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('job');
        $this->assertControllerName(JobController::class); // as specified in router's controller name alias
